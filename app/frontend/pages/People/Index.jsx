      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900">{t('people.index.heading')}</h1>
            {current_user && (
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('people.index.search_filters')}</h2>
          ...
          {people.length === 0 ? (
            <div className="bg-white rounded-lg shadow p-8 text-center">
              <p className="text-gray-500 mb-4">{t('people.index.empty_title')}</p>
              {current_user && (
                  ...
                  >
                    ...
                    <div className="mt-3 space-y-2">
                      ...
                      <Link
                        ...
                        onClick={(e) => e.stopPropagation()}
                        title={t('people.index.new_timeline_title')}
                      >
