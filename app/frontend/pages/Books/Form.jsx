          ...
          <div className="bg-white rounded-lg shadow p-6">
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Optional - defaults to the filename if not provided
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 rounded-md">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">Uploaded on {new Date(book.created_at).toLocaleDateString()}</p>
                      </div>
                      {book.attachment_url && (
                        <a
              ...
              <div className="mt-6 flex items-center justify-end gap-3">
                ...
                >
                  {processing ? (isEdit ? 'Saving...' : 'Uploading...') : (isEdit ? 'Save Changes' : 'Upload Book')}
                </button>
              </div>
            </form>
          </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-yellow-700">
                    You can only edit the book name and location. The PDF file cannot be changed after upload.
                  </p>
                </div>
              </div>
            </div>
