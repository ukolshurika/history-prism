    ...
    <Layout current_user={current_user} flash={flash}>
      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">{t('books.index.heading')}</h1>

            {/* Upload Form */}
            {current_user && (
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">{t('books.index.upload_heading')}</h2>
          ...
          {books.length === 0 ? (
            <div className="bg-white rounded-lg shadow p-8 text-center">
              ...
              <p className="text-gray-500 mb-4 mt-4">{t('books.index.empty_title')}</p>
              {current_user && (
                <p className="text-sm text-gray-400">
                  {t('books.index.empty_description')}
                </p>
              )}
            </div>
          ) : (
